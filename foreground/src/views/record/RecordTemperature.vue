    ...
    <el-card class="page-container" v-if="isTest">
        ...
        <el-row>
            ...
            <el-form-item label="分析和建议">
                <div class="message-text mine">{{ temperature.result }}</div>
            </el-form-item>
        </el-row>
        <!-- 咨询抽屉 -->
...
const getHistory = async () => {
    let result = await getHistoryService(startRow, "体温分析");
    let restCount = await countService(startRow, "体温分析");
...
const sendMessage = async () => {
    ...
    let result = await chatService(inputText.value, "体温分析");
    inputText.value = "";
